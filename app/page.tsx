  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="flex flex-col items-center justify-center">
        <h1 className="fade-in.visible text-4xl font-bold text-center">Music Meet</h1>
        <br></br>
        <p className="text-center">A place to meet new people and listen to music together</p>
      </div>
